...
export const HeroSection = ({ onChooseLocation }) => {
  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center text-white z-0 overflow-visible">
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="size-[500px] md:size-[620px] circles"></div>
        <div className="md:size-[900px] size-[650px] circles"></div>
        <div className="md:size-[1200px] size-[800px] circles"></div>
        <div className="md:size-[1500px] size-[950px] circles"></div>
      </div>

      <HeroOrbit size={800} rotation={-71}>
        <img src={starIcon} alt="star" className="size-14 stars" />
      </HeroOrbit>
      <HeroOrbit size={500} rotation={17}>
        <img src={starIcon} alt="star" className="size-12 stars" />
      </HeroOrbit>
      <HeroOrbit size={590} rotation={98}>
        <img src={starIcon} alt="star" className="size-8 stars" />
      </HeroOrbit>

      <HeroOrbit size={430} rotation={-14}>
        <img src={sparkleIcon} alt="sparkle" className="size-8 sparkle" />
      </HeroOrbit>
      <HeroOrbit size={440} rotation={79}>
        <img src={sparkleIcon} alt="sparkle" className="size-5 sparkle" />
      </HeroOrbit>
      <HeroOrbit size={530} rotation={178}>
        <img src={sparkleIcon} alt="sparkle" className="size-10 sparkle" />
      </HeroOrbit>
      <HeroOrbit size={710} rotation={144}>
        <img src={sparkleIcon} alt="sparkle" className="size-14 sparkle" />
      </HeroOrbit>
      ...
      <HeroOrbit size={720} rotation={95}>
        <div className="size-2 rounded-full bg-[#BDC4D4] opacity-20" />
      </HeroOrbit>
      <HeroOrbit size={520} rotation={-42}>
        <div className="size-2 rounded-full bg-[#BDC4D4] opacity-20" />
      </HeroOrbit>
      <HeroOrbit size={650} rotation={-5}>
        <div className="size-1 rounded-full bg-[#BDC4D4] opacity-20" />
      </HeroOrbit>
      ...
      <section className="container px-4">
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-[#BDC4D4] md:text-lg">
            ...
            {t("hero.description.line4")} <b>{t("hero.suhur")}</b>{" "}
